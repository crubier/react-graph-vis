...
var Graph = function (_Component) {
  ...
  function Graph(props) {
    ...
    _this.edges = new _vis2.default.DataSet();
    _this.edges.add(graph.edges);
    _this.nodes = new _vis2.default.DataSet();
    _this.edges.add(graph.nodes);
    _this.state = {
  ...
  _createClass(Graph, [{
    ...
    value: function shouldComponentUpdate(nextProps, nextState) {
      ...
      if (nodesChange) {
        var nodesRemoved = (0, _differenceWith2.default)(this.props.graph.nodes, nextProps.graph.nodes, _isEqual2.default);
        var nodesAdded = (0, _differenceWith2.default)(nextProps.graph.nodes, this.props.graph.nodes, _isEqual2.default);
        this.patchNodes({ nodesRemoved: nodesRemoved, nodesAdded: nodesAdded });
      }
...
Graph.defaultProps = {
  graph: {},
  getNetwork: _react2.default.PropTypes.function,
