...
var diff = function diff(current, next) {
  ...
  var unchanged = (0, _intersectionWith2.default)(next, current, _isEqual2.default);

  var updated = (0, _differenceWith2.default)((0, _intersectionWith2.default)(next, current, function (a, b) {
    return a[field] === b[field];
  }), unchanged, _isEqual2.default);

  var added = (0, _differenceWith2.default)((0, _differenceWith2.default)(next, current, _isEqual2.default), updated, _isEqual2.default);
