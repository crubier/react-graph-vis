...
var _visjsNetwork = require("visjs-network");

var _visjsNetwork2 = _interopRequireDefault(_visjsNetwork);
...
var Graph = function (_Component) {
  ...
  _createClass(Graph, [{
    ...
    value: function componentDidMount() {
      this.edges = new _visjsNetwork2.default.DataSet();
      this.edges.add(this.props.graph.edges);
      this.nodes = new _visjsNetwork2.default.DataSet();
    ...
    value: function shouldComponentUpdate(nextProps, nextState) {
      ...
      if (edgesChange) {
        ...
        var _edgesChanged = (0, _differenceWith2.default)((0, _differenceWith2.default)(nextProps.graph.edges, this.props.graph.edges, _isEqual2.default), edgesAdded);
        this.patchEdges({ edgesRemoved: edgesRemoved, edgesAdded: edgesAdded, edgesChanged: _edgesChanged });
      }
    ...
    value: function updateGraph() {
      ...
      this.Network = new _visjsNetwork2.default.Network(container, Object.assign({}, this.props.graph, {
        edges: this.edges,
        nodes: this.nodes
      }), options);
